  ...
  return (
    <>
      <section className="relative pb-20 pt-32">
        ...
        />
        <div className="absolute inset-0 bg-ers-green-900/75" />
        <div className="container-wide relative mx-auto px-4 text-center lg:px-8">
          <span className="inline-block rounded-full bg-ers-orange-600 px-4 py-1 text-sm font-semibold text-white">
            {t('niakharStatus')}
          </span>
            ...
            {details.map((d, i) => (
              <ScrollReveal key={d.label + d.value} delay={i * 0.1}>
                <div className="rounded-xl border border-gray-100 bg-white p-5 shadow-sm">
                  <d.icon className="mb-2 h-5 w-5 text-ers-orange-600" />
        ...
        <div className="container-wide mx-auto">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            <ScrollReveal direction="right">
              ...
              <div className="mt-3 h-1 w-16 rounded-full bg-ers-orange-500" />
              <p className="mt-6 text-lg leading-relaxed text-gray-700">
                {t('niakharDesc')}
              </p>
              <div className="mt-6 rounded-xl bg-ers-orange-50 p-5 border-l-4 border-ers-orange-500">
